...
export function Hero() {
  return (
    <motion.section
      ...
      className="relative rounded-tt-xl overflow-hidden border border-tt-border/10 tt-gradient-soft shadow-tt"
    >
      <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative p-6 lg:p-8">
          ...
          <div className="relative rounded-tt-xl overflow-hidden shadow-md">
            <video
        ...
        <div className="relative p-6 lg:p-10 flex items-center">
          ...
          <div className="relative max-w-xl">
            <h1 className="font-heading text-4xl lg:text-5xl font-bold text-tt-primary">
              Welcome to <span className="tt-logo">TaleTime</span>
            </h1>
            <p className="mt-4 font-body text-base lg:text-lg text-tt-muted leading-relaxed">
